...
async function main() {
    ...
    const contractInstantiateTx = new ContractCreateTransaction()
        ...
        .setGas(100000)
        .setConstructorParameters(new ContractFunctionParameters().addString('Ankit').addUint256(1111111111))
    ...
    const contractQueryTx = new ContractCallQuery()
        ...
        .setGas(100000)
        .setFunction('getMobileNumber', new ContractFunctionParameters().addString('Ankit'))
    ...
    const contractExecuteTx = new ContractExecuteTransaction()
        .setContractId(contractId)
        .setGas(100000)
        .setFunction('setMobileNumber', new ContractFunctionParameters().addString('Bhuvan').addUint256(2222222222))
    ...
    const contractQueryTx2 = new ContractCallQuery()
        .setContractId(contractId)
        .setGas(100000)
        .setFunction('getMobileNumber', new ContractFunctionParameters().addString('Bhuvan'))
        .setMaxQueryPayment(new Hbar(0.2));
    ...
    console.log(`- Here's the phone number that you asked for: ${contractQueryResult2}`);
